...
// remains available.
extern "C" JNIEXPORT jlong JNICALL
Java_com_google_ai_edge_litert_support_text_tokenizers_BertTokenizer_nativeLoadResource(  // NOLINT
    JNIEnv* env, jobject thiz, jobject vocab_list, jint max_bytes_per_token,
    jint max_chars_per_sub_token, jstring jsuffix_indicator,
    jboolean use_unknown_token, jstring junknown_token,
    jboolean split_unknown_chars) {
  return Java_org_tensorflow_lite_support_text_tokenizers_BertTokenizer_nativeLoadResource(
      env, thiz, vocab_list, max_bytes_per_token, max_chars_per_sub_token,
      jsuffix_indicator, use_unknown_token, junknown_token,
      split_unknown_chars);
}

extern "C" JNIEXPORT jlong JNICALL
Java_com_google_ai_edge_litert_support_text_tokenizers_BertTokenizer_nativeUnloadResource(  // NOLINT
    JNIEnv* env, jobject thiz, jlong handle) {
  return Java_org_tensorflow_lite_support_text_tokenizers_BertTokenizer_nativeUnloadResource(
      env, thiz, handle);
}

extern "C" JNIEXPORT jobjectArray JNICALL
Java_com_google_ai_edge_litert_support_text_tokenizers_BertTokenizer_nativeTokenize(  // NOLINT
    JNIEnv* env, jobject thiz, jlong handle, jstring jtext) {
  return Java_org_tensorflow_lite_support_text_tokenizers_BertTokenizer_nativeTokenize(
      env, thiz, handle, jtext);
}

extern "C" JNIEXPORT jintArray JNICALL
Java_com_google_ai_edge_litert_support_text_tokenizers_BertTokenizer_nativeConvertTokensToIds(  // NOLINT
    JNIEnv* env, jobject thiz, jlong handle, jobjectArray jtokens) {
  return Java_org_tensorflow_lite_support_text_tokenizers_BertTokenizer_nativeConvertTokensToIds(
